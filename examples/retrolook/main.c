...
int main(int argc, const char *argv[]) {
  ...
  // Initialize vk2d
  VK2DRendererConfig config = {VK2D_MSAA_1X, VK2D_SCREEN_MODE_TRIPLE_BUFFER,
                               VK2D_FILTER_TYPE_NEAREST};
  VK2DVec4 clear = {0.1, 0.0, 0.2, 1.0};
  ...
  // Create cameras
  VK2DCameraSpec camera3D = {VK2D_CAMERA_TYPE_PERSPECTIVE,
                             0,
                             0,
                             LOGICAL_WIDTH,
                             LOGICAL_HEIGHT,
