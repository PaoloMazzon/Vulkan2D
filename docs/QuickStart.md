...
## Shaders
Shaders are more advanced feature that allows you to have full control over how the final pixels get
rendered for any given texture. For more information, please see [the shaders page](Shaders.md).