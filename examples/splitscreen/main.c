...
int main(int argc, const char *argv[]) {
  ...
  // Initialize vk2d
  VK2DRendererConfig config = {VK2D_MSAA_32X, VK2D_SCREEN_MODE_TRIPLE_BUFFER,
  ...
  // Create cameras
  VK2DCameraSpec cameraSpec = {VK2D_CAMERA_TYPE_DEFAULT,
                               0,
                               0,
                               WINDOW_WIDTH / 2,
                               WINDOW_HEIGHT / 2,
  ...
  VK2DCameraSpec cameraSpec2 = {VK2D_CAMERA_TYPE_DEFAULT,
                                100,
                                50,
                                WINDOW_WIDTH / 3,
                                WINDOW_HEIGHT / 3,
  ...
  VK2DCameraSpec cameraSpec3 = {VK2D_CAMERA_TYPE_DEFAULT,
                                50,
                                0,
                                WINDOW_WIDTH / 2,
                                WINDOW_HEIGHT / 2,
  ...
  VK2DCameraSpec cameraSpec4 = {VK2D_CAMERA_TYPE_DEFAULT,
                                0,
                                100,
                                WINDOW_WIDTH,
                                WINDOW_HEIGHT,
  ...
  while (!quit) {
    ...
    // We disable the default camera first since we don't want to draw to that
    // (its used for ui here)
    vk2dCameraSetState(VK2D_DEFAULT_CAMERA, VK2D_CAMERA_STATE_DISABLED);
    vk2dDrawPolygon(testPoly, 0, 0);
    vk2dDrawTextureExt(texCaveguy, 100 + (sin(time * 2) * 100), 100, 10, 10,
                       time, 8, 8);
    ...
    vk2dRendererDrawRectangleOutline(0, 0, WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2,
                                     0, 0, 0, 1);
    vk2dRendererDrawRectangleOutline(WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2,
                                     WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2, 0, 0,
                                     0, 1);
