...
/// \brief Gets the vertex input information for VK2DVertexTexture (Uses static
/// variables to persist attached descriptions)
VkPipelineVertexInputStateCreateInfo _vk2dGetTextureVertexInputState();

/// \brief Gets the vertex input information for VK2DVertex3D (Uses static
/// variables to persist attached descriptions)
...
/// \brief Gets the vertex input information for VK2DVertexColour (Uses static
/// variables to persist attached descriptions)
...
VK2DTexture _vk2dTextureFromInternal(const void *data, int size,
                                     bool mainThread);

/// \brief The internal model creation function
VK2DModel _vk2dModelFromInternal(const void *objFile, uint32_t objFileSize,
                                 VK2DTexture texture, bool mainThread);